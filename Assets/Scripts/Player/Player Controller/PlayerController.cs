...
namespace Player.PlayerController
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [HideInInspector]public string ninja;
        
        private PlayerDefaults PlayerDefaults;
        [Header("Player Settings")]
        [Tooltip("Refers to the speed of the player")]
        [Range(0,10)]
        [SerializeField]private float _speed;
        [SerializeField]private float _jumpForce = 10f;
        [Space(30)]
        [SerializeField]private float _lazerBeamRange = 2f;
        ...
        private void Start()
        {
            Invoke(nameof(DebugFunction), 2f);

            InvokeRepeating(nameof(DebugFunction), 2f, 1f);

            CancelInvoke(nameof(DebugFunction));
        }
        ...
        void Update()
        {
            ...
            transform.Translate(_speed * Time.deltaTime * Xinput, _speed * Time.deltaTime * yinput,
